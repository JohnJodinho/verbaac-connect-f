...
const AddressDisplay = ({ address }: { address: string }) => {
    ...
    // Simple mock masking logic: split by comma, take the last part (usually city/area)
    const parts = address.split(',');
    const generalArea = parts.length > 1 ? parts[parts.length - 2].trim() : address; // e.g. "Naraguta" from "10 Bauchi Rd, Naraguta, Jos"
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-2/3 p-4 md:p-6 flex flex-col">
          ...
          <div className="flex items-center text-muted-foreground mb-4 text-sm">
            ...
            <AddressDisplay address={property.location.address} />
          </div>
